...
const App = () => {
  ...
  <ul tabindex="0" class="dropdown-content bg-base-300 rounded-box z-1 w-50 h-60 overflow-auto p-2 shadow-2xl">
    ...
    <li>
      ...
      <div className='w-full h-1/2  flex justify-center items-center mt-15'>
    <div className='w-[80%] h-full flex flex-row justify-center text-center items-center'>
    <div className='w-1/3 h-full flex flex-col justify-center item-center gap-4'>
<img src="/profile.png" alt="profile" className='size-70 w-full f-full object-cover object-top   hover:scale-105 transition-all duration-300 glow-image' />
<p className='text-xl underline underline-offset-2'><i>Radhika Sanjay Suryawanshi</i></p>
    </div>
      <div className='w-2/3 h-full  flex justify-center items-center mx-5'>
<p className='w-full font-semibold text-5xl leading-20 '>Passionate developer dedicated to turning ideas&nbsp;<span class="animate-pulse glow">💡</span>
